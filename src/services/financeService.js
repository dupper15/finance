...
export class FinanceService {
    ...
    async getTransactions(filters = {}) {
        ...
        const response = await apiService.get(`/transactions${queryString ? '?' + queryString : ''}`);
    ...
    async createTransaction(transactionData) {
        ...
        const requiredFields = ['account_id', 'description', 'amount', 'transaction_date', 'transaction_type'];
    ...
    async bulkDeleteTransactions(transactionIds) {
        ...
        const deletePromises = transactionIds.map(id => this.deleteTransaction(id));
