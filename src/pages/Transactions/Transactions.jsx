						...
						<div className="mt-3 text-center">
							<div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-red-100">
								<svg
									...
									<path
										...
										strokeLinejoin="round"
										strokeWidth={2}
										d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-2.694-.833-3.464 0L3.34 16c-.77.833-.192 2.5 1.732 2.5z"
									/>
								</svg>
							</div>
							...
							<div className="mt-2 px-7 py-3">
								<p className="text-sm text-gray-500">
									...
									{deleteConfirm.description}"? Hành động này không thể hoàn
									tác.
								</p>
							</div>
